...
class SWM201(object):
    ...
    PAGE_SIZE = 512
    SECT_SIZE = 512
    CHIP_SIZE = 0x8000  # 32K

    def __init__(self, xlink):
        super(SWM201, self).__init__()

        self.xlink = xlink

        self.xlink.reset()
        self.flash = Flash(self.xlink, SWM201_flash_algo)
...
SWM201_flash_algo = {
    ...
    'instructions' : [
        ...
        0x07802001, 0x60C16081, 0x47702000, 0x47702000, 0xD00105C1, 0x47702001, 0x6A0A4936, 0xDAFC2A00,
        0x0252227F, 0x22FF4010, 0x18800612, 0x6A086088, 0xD5FC06C0, 0x22106A08, 0x62084310, 0x07C06A08,
        0x6088D1FC, 0xB5104770, 0xD00105C3, 0xBD102001, 0x08891CC9, 0x4B270089, 0x2C006A1C, 0x03C4DAFC,
        ...
        0x47702001, 0x05C3B510, 0x2001D001, 0x1CC9BD10, 0x00890889, 0x6A1C4B07, 0xDAFC2C00, 0x6813E006,
        0x42A36804, 0x1D00D1F2, 0x1F091D12, 0xD1F62900, 0x0000BD10, 0x4004A000, 0xE000E180, 0xFF010000,
        0x00000000
    ],
